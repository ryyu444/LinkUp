...
async function testDB() {
  ...
  const userList = usersSnapshot.docs.map((user) => {
    ...
    <main className='h-[calc(100vh-64px)] bg-white text-gray-900'>
      ...
      <section className='h-2/3 grid grid-cols-1 md:grid-cols-2 gap-10 items-center p-10'>
        <div>
          ...
          <p className='text-2xl text-gray-900'>
            <strong>
              LinkUp connects university students for collaborative study
              sessions. Find partners who match your learning style, subject
      ...
      <section className='h-1/3 bg-blue-50 py-12 px-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center'>
        <div className='bg-white shadow-md rounded p-6'>
          ...
          <div className='mb-4'>
            <Image
              src='/logo_CreateStudySessions.png'
              alt='Create Study Sessuins Logo'
              width={40}
              height={40}
            />
          </div>
          ...
          <p className='text-sm text-gray-700'>
            Schedule study sessions for any subject and invite others to join.
          </p>
        </div>
        {/* the find sessions */}
        <div className='bg-white shadow-md rounded p-6'>
          <div className='mb-4'>
            <Image
              src='/logo_FindStudySection.png'
              alt='Find Sessions Logo'
              width={40}
              height={40}
            />
          </div>
          ...
          <p className='text-sm text-gray-700'>
            Browse and filter study sessions based on subject, location, and
            time.
          </p>
        </div>
        ...
        <div className='bg-white shadow-md rounded p-6'>
          <div className='mb-4'>
            <Image
              src='/logo_ConnectWithPeers.png'
              alt='Connect With Peers Logo'
              width={40}
              height={40}
            />
          </div>
          ...
          <p className='text-sm text-gray-700'>
            Meet students with similar academic interests and learning styles.
          </p>
        </div>
      </section>
    </main>
