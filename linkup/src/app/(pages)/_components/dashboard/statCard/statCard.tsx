...
export default function StatCard() {
  return (
    <div className="w-full h-60 bg-white rounded-lg shadow-[0_1px_3px_0_rgba(0,0,0,0.10)] outline-1 outline-offset-[-1px] outline-gray-200 p-6 font-['Inter']">
      <div className="text-sky-950 text-lg font-bold leading-7 mb-6">Your Stats</div>
      ...
      <div className="grid grid-cols-2 gap-y-8">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <p className="text-gray-600 text-sm leading-tight">Sessions Joined</p>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <p className="text-gray-600 text-sm leading-tight">Sessions Created</p>
